...
WIN_LINK_FLAGS = -L$(LIBSODIUM_WIN_LIB) -L$(LZ4_WIN_LIB) -L$(ZSTD_WIN_LIB) -L$(XZ_WIN_LIB) -L$(ZLIB_WIN_LIB) -L$(LIBZIP_WIN_LIB) -lsodium -llz4 -lzip -lzstd -llzma -lz -lbcrypt -lws2_32 -static-libstdc++ -static-libgcc --static
